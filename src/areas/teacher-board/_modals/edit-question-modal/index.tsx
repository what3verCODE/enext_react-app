...
function EditQuestionModal(props: IProps) {
    const [question, setQuestion] = useState<QuestionEntity>(props.question);
    const [editQuestionForm] = a.Form.useForm();
    ...
    return <a.Modal
        title={"Редактирование вопроса: " + props.question.value}
    ...
    >
        ...
        >
            ...
            <a.Form.Item name="score"
                         ...
                         rules={[{required: true}]}
            >
                <a.InputNumber value={question.score}
                               onChange={(v) =>
